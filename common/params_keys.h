...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"RaveEnabled", {PERSISTENT | DONT_LOG, BOOL, "0"}},
    {"RavePeerId", {PERSISTENT | DONT_LOG, STRING}},
    {"RavePeerName", {PERSISTENT | DONT_LOG, STRING}},
    {"RavePairingKey", {PERSISTENT | DONT_LOG, BYTES}},
    {"RavePairRequest", {CLEAR_ON_MANAGER_START | DONT_LOG, BOOL, "0"}},
    ...
    {"Model", {PERSISTENT, STRING, "rdf", "rdf", 1}},
    {"ModelVersion", {PERSISTENT, STRING, "v15", "v15", 1}},
    {"DrivingModel", {PERSISTENT, STRING, "rdf", "rdf", 1}},
    {"DrivingModelName", {PERSISTENT, STRING, "Regret Driven Framework", "Regret Driven Framework", 1}},
